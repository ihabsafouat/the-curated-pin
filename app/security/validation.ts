...
export const articleBlockSchema = z.discriminatedUnion("type", [
  ...
  z.object({ id: blockId, type: z.literal("product_cta"), eyebrow: shortText, title: shortText.min(2), body: bodyText.min(10), cta: shortText.min(2), url: safeSiteOrExternalUrl.refine(Boolean), price: shortText, image: safeExternalUrl, imageAlt: shortText }),
